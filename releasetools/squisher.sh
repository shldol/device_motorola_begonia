...
# set in squisher
# DEVICE_OUT=$ANDROID_BUILD_TOP/out/target/product/begonia
# DEVICE_TOP=$ANDROID_BUILD_TOP/device/motorola/begonia
# VENDOR_TOP=$ANDROID_BUILD_TOP/vendor/motorola/begonia
