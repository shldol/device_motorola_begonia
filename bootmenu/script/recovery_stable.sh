...
PART_DATA=/dev/block/mtdblock8
PART_SYSTEM=/dev/block/mtdblock6
...
usleep 50000
mount -t yaffs2 -o rw,noatime,nodiratime $PART_SYSTEM /system
...
[ ! -d /data/data ] &&         mount -t yaffs2 -o rw,noatime,nodiratime,errors=continue $PART_DATA /data
[ ! -f /system/build.prop ] && mount -t yaffs2 -o rw,noatime,nodiratime,errors=continue $PART_SYSTEM /system
